    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <form class="form" action="{{ route('leitor_update', $leitor->id) }}" method="POST" id="formleitor">
                    @csrf
                    @method('PUT')
                    <div class="input-box">
                        <label>Nome completo</label>
                        <input type="text" name="nome" value="{{ $leitor->nome }}" placeholder="Digite seu nome" required="">
                    </div>
                    <div class="column">
                        <div class="input-box">
                            <label>E-mail</label>
                            <input type="email" name="email" value="{{ $leitor->email }}" placeholder="Digite seu e-mail" required="">
                        </div>
                        <div class="input-box">
                            <label>Telefone</label>
                            <input type="text" name="telefone" value="{{ $leitor->telefone }}" placeholder="Digite seu telefone" required="">
                        </div>
                        <div class="input-box">
                            <label>Código de Cadastro</label>
                            <input type="number" name="n_cadastro" value="{{ $leitor->n_cadastro }}" id="n_cadastro" readonly>
                        </div>
                    </div>
