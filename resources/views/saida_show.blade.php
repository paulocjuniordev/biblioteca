                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/register" class="nav-link text-white">
                                ...
                                <p>Cadastrar novo usuário do sistema</p>
                            </a>
                        </li>
                        <li class="nav-item">
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Lista de Livros Indisponíveis</h3>
            </div>
            <div class="card">
                <!-- /.card-header -->
            ...
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped" language="pt-br">
                    ...
                    @foreach ($saidas as $saida)
                        <tr>
                            <td>{{ $saida->id }}</td>
                            <td>{{ $saida->leitor->nome }}</td>
                            <td>{{ $saida->livro->nome }}</td>
                            <td>{{ $saida->data_saida }}</td>
                            <td>{{ $saida->data_devolucao }}</td>
                            <td>
                                <a href="{{ route('editar_saida', $saida->id) }}">
                            ...
                            <td>
                                <form action="{{ route('excluir_saida', $saida->id) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
